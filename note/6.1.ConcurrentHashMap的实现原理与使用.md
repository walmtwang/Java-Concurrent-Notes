...
- 通过ConcurrentHashMap的类图来分析ConcurrentHashMap的结构，如下图所示。![ConcurrentHashMap的类图](https://github.com/walmt/Java-Concurrent-Notes/blob/master/img/106.png?raw=true)
...
- ConcurrentHashMap是由Segment数组结构和HashEntry数组结构组成。
  ...
  ![ConcurrentHashMap的结构图](https://github.com/walmt/Java-Concurrent-Notes/blob/master/img/107.png?raw=true)
