...
4. 结点出队失败，重新进行出队(关于p == q的判断条件我是在有点难以理解，在此只能作一个不负责任的猜测：
   ...
   - A线程执行步骤5后(为了方便没有画出tail，**再次声明，只是个人观点**)：![](https://github.com/walmt/Java-Concurrent-Notes/blob/master/img/116.png?raw=true)
   - B线程抢先删除结点后B线程执行步骤4：![](https://github.com/walmt/Java-Concurrent-Notes/blob/master/img/117.png?raw=true)
